# Gateway
resource "valtix_gateway" "valtix_gateway_egress" {
	name                    = var.valtix_gateway_egress_name
	description             = ""
	...
	policy_rule_set_id      = valtix_policy_rule_set.policy_ruleset_egress.rule_set_id
